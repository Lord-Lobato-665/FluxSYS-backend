    ...
    public class InventoriesController : ControllerBase
    {
        ...
        public async Task<IActionResult> Create([FromBody] InventoryViewModel model)
        {
            ...
            try
            {
                ...
                await _service.AddAsyncInventory(dto);
        ...
        public async Task<IActionResult> Update(int id, [FromBody] InventoryViewModel model)
        {
            if (!ModelState.IsValid)
                return BadRequest(ModelState);
            ...
            try
            {
                ...
                await _service.UpdateAsyncInventory(id, dto);
        ...
        public async Task<IActionResult> SoftDelete(int id)
        {
            try
            {
                await _service.SoftDeleteAsyncInventory(id);
        ...
        public async Task<IActionResult> Restore(int id)
        {
            try
            {
                await _service.RestoreAsyncInventory(id);
